...
def main():
    ...
    parser.add_argument("--width", type=int, default=1280, help="capture width; 0 for auto max")
    parser.add_argument("--height", type=int, default=720, help="capture height; 0 for auto max")
